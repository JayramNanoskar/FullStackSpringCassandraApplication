package com.jayram.bookreads.user;
...
// Model to represent the books read by a user. Helps showing user's recent books in the dashboard page.
...
public class BooksByUser {
    ...
    //Overriding equals() & hashCode() to say if two of these BooksByUser instances have the same book id & author id then we want to consider those two as the same
    @Override
    public int hashCode() {
        final int prime = 31;
        int result = 1;
